...
main_frame = Frame(root, borderwidth=0, bg=bg_color)    # Second frame in Root window - Main_frame
screen_frame = Frame(root, borderwidth=0, bg=bg_color)  # Third frame in Root window - Screen_frame
Mid_frame = Frame(root, borderwidth=0, bg=bg_color)     # Forth frame in Root window - Mid_frame
